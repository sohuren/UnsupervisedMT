...
CUDA_VISIBLE_DEVICES=0,1,2 python main_parallel.py \
        ...
        --mono_directions 'en,fr' --word_shuffle 3 --word_dropout 0.1 --word_blank 0.2 --pivo_directions 'fr-en-fr,en-fr-en' \
