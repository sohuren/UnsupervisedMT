...
DATA_PATH=$PWD/data
MONO_PATH=$DATA_PATH/mono_en_ru
PARA_PATH=$DATA_PATH/para_en_ru
...
BPE_CODES=$MONO_PATH/bpe_codes.en_ru
...
TGT_VALID=$PARA_PATH/dev/newstest2013-ref.ru
SRC_TEST=$PARA_PATH/dev/newstest2014-ruen-src.en
TGT_TEST=$PARA_PATH/dev/newstest2014-ruen-src.ru
...
#wget -c http://www.statmt.org/wmt14/training-monolingual-news-crawl/news.2007.ru.shuffled.gz
...
wget -c http://www.statmt.org/wmt14/training-monolingual-news-crawl/news.2013.ru.shuffled.gz
...
echo "RU monolingual data concatenated in: $TGT_RAW"
...
if ! [[ "$(wc -l < $TGT_RAW)" -eq "$N_MONO" ]]; then echo "ERROR: Number of lines doesn't match! Be sure you have $N_MONO sentences in your RU monolingual data."; exit; fi
...
echo "BPE codes applied to RU in: $TGT_TOK.$CODES"
...
echo "RU binarized data in: $TGT_TOK.$CODES.pth"
...
echo "    RU: $TGT_TOK.$CODES.pth"
echo "Parallel validation data:"
echo "    EN: $SRC_VALID.$CODES.pth"
echo "    RU: $TGT_VALID.$CODES.pth"
echo "Parallel test data:"
echo "    EN: $SRC_TEST.$CODES.pth"
echo "    RU: $TGT_TEST.$CODES.pth"
echo ""
