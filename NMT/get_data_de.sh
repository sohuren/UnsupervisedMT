...
PARA_PATH=$DATA_PATH/para_en_de
...
TGT_VALID=$PARA_PATH/dev/newstest2013-ref.de
SRC_TEST=$PARA_PATH/dev/newstest2014-deen-src.en
TGT_TEST=$PARA_PATH/dev/newstest2014-deen-src.de
